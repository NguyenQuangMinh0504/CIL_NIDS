...
def get_convnet(convnet_type: str, pretrained: bool = False) -> tuple[nn.Module, nn.Module]:
    ...
    if name == "resnet32":
        ...
        return get_memo_ann(input_dim=120)
    elif name == "kdd_memo_dnn":
        return get_memo_dnn(input_dim=120)
    elif name == "kdd_ann":
        return get_ann(input_dim=120)
    elif name == "kdd_dnn":
        return get_dnn(input_dim=120)
...
class IncrementalNet(BaseNet):
    def __init__(self, convnet_type, pretrained, gradcam=False):
        super(IncrementalNet, self).__init__(convnet_type, pretrained)
